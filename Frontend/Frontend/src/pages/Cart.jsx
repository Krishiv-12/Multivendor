...
const Cart = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-10">
      {/* Heading */}
      <h2 className="text-3xl md:text-4xl font-semibold font-darker text-gray-900 mb-8">
        Shopping Cart
      </h2>
      ...
      {cart.length === 0 ? (
        ...
        <div className="flex flex-col items-center justify-center py-20 bg-gray-50 rounded-xl">
          ...
          <Link
            to="/shop"
            className=" bg-black text-white px-3 py-2 rounded-lg font-semibold hover:bg-white hover:text-black border border-gray-300 transition duration-300"
          >
            Continue Shopping
          </Link>
        </div>
        ...
        item.quantity === 1
          ...
          <div className="bg-white rounded-xl shadow-sm border p-6 h-fit">
            ...
            <Link to="/checkout" state={{ cart, totalPrice }}>
              <button className="mt-6 w-full bg-black text-white py-3 rounded-lg font-semibold hover:bg-white hover:text-black border border-gray-300 transition duration-300">
                Proceed to Checkout
              </button>
            </Link>
          </div>
