...
const Wishlist = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto mt-12 px-4 py-10">
      <h2 className="text-3xl font-semibold mb-8 text-gray-800">My Wishlist</h2>
              ...
              <div className="p-5">
                ...
                <div className="flex gap-3">
                  <button
                    ...
                    className="flex-1 bg-black text-white py-2 rounded-lg text-sm font-medium hover:bg-white hover:text-black transition duration-300 border border-gray-300"
                  >
                    Add to Cart
                  </button>
