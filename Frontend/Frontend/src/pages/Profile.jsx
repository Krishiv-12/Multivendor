    ...
    <div className="min-h-[80vh] flex items-start justify-center px-4 mt-12">
      <div className="w-full max-w-lg bg-white dark:bg-slate-800 shadow-xl rounded-2xl p-6">
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h2 className="text-4xl font-darker font-semibold text-gray-800 dark:text-white">
              My Profile
            </h2>
        ...
        <div className="space-y-4">
          ...
          <button
            ...
            className="w-full mt-2 bg-black hover:bg-white hover:text-black text-white py-2.5 rounded-lg font-semibold transition duration-300 border border-gray-300"
          >
            Update Profile
          </button>
        </div>
